...
export const metadata: Metadata = {
    title: "Home",
    description:
        "Snap Lessons – Hyderabad's leading digital marketing agency. SEO, Google Ads, Social Media, Web Development & Digital Marketing Courses. Grow 10x with us.",
};
            ...
            <section className="py-24 bg-dark">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <StaggerReveal className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                            { name: "Rahul Sharma", company: "TechNova Pvt Ltd", text: "Snap Lessons tripled our organic traffic in just 4 months. Their SEO strategy is unmatched in Hyderabad!", rating: 5 },
                            { name: "Priya Reddy", company: "EcoSpark Organics", text: "Our Google Ads ROI improved by 340% after hiring Snap Lessons. Every rupee spent shows clear results.", rating: 5 },
